...
class HTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle().copyWith(fontSize: HSizes.fontSizeSm,color: HColors.black),
    hintStyle: const TextStyle().copyWith(fontSize: HSizes.fontSizeSm,color: HColors.black),
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal),
    floatingLabelStyle: const TextStyle().copyWith(color: HColors.black.withOpacity(0.8)),
   ...
   static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    suffixIconColor: HColors.darkGrey,
    //constraints: const BoxConstraints.expand(height: 14.inputFieldHeight),
    labelStyle: const TextStyle().copyWith(fontSize: HSizes.fontSizeSm,color: HColors.white),
    hintStyle: const TextStyle().copyWith(fontSize: HSizes.fontSizeSm,color: HColors.white),
    floatingLabelStyle: const TextStyle().copyWith(color: HColors.white.withOpacity(0.8)),
    border: const OutlineInputBorder().copyWith(
     borderRadius: BorderRadius.circular(HSizes.inputFieldRadius),
