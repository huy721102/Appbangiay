...
class HVerticallmageText extends StatelessWidget {
  const HVerticallmageText({
    super.key, 
    required this.image, 
    required this.title, 
        ...
        child: Column(
           children: [
            ...
            Container(
             ...
             child: Center(
               child: Image(image: AssetImage(image),fit: BoxFit.cover,color:dark ? HColors.light:HColors.black),
             ),
            ),
            //text
